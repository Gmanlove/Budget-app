...
ActiveRecord::Schema[7.0].define(version: 2023_07_04_082459) do
  ...
  add_foreign_key "expense_categories", "categories", on_delete: :cascade
  add_foreign_key "expense_categories", "expenses", on_delete: :cascade
