...
<div style="text-align: center;">
  <img src="https://freepngimg.com/download/money/170453-financial-budget-download-hd.png" alt="Alt Text" width="200">
</div>
...
Clone this [repository](git@github.com:Gmanlove/Budget-app.git) to your desired folder:

```sh
  git clone git@github.com:Gmanlove/Budget-app.git
  cd Budget-app
```
...
Feel free to check the [issues page](https://github.com/Gmanlove/Budget-app/issues).
